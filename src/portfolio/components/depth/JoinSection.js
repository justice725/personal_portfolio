    ...
    return (
        <>
            ...
            <SectionCard>
                <ul>
                    <li className=''><span
                        className='align-middle w-[5px] h-[5px] min-w-[5px] min-h-[5px] mr-[8px] bg_circle inline-block rounded-[51%] mb-[5px]'></span>제품은
                        무엇보다 <strong>사용자 중심적</strong>이어야 한다고 믿어요. 사용자의 입장에서 무엇이 더 좋은 것일지를 생각해요.
                    </li>
                    <li className=''><span
                        className='align-middle w-[5px] h-[5px] min-w-[5px] min-h-[5px] mr-[8px] bg_circle inline-block rounded-[51%] mb-[5px]'></span><strong>디자인
                        시스템 구축 및 유지보수</strong>를 통해 메이커들의
                        생산성을 높이는 데에 기여하고 있어요.
                    </li>
                    <li className=''><span
                        className='align-middle w-[5px] h-[5px] min-w-[5px] min-h-[5px] mr-[8px] bg_circle inline-block rounded-[51%] mb-[5px]'></span>
                    ...
                    <li className=''><span
                        className='align-middle w-[5px] h-[5px] min-w-[5px] min-h-[5px] mr-[8px] bg_circle inline-block rounded-[51%] mb-[5px]'></span><strong>좋은
                        코드에 대한 고민</strong>에 더해서, 비즈니스적
